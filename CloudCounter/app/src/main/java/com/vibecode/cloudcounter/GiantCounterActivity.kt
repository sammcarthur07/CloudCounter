...
class GiantCounterActivity : AppCompatActivity(), SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private var allSmokers: List<com.vibecode.cloudcounter.Smoker> = emptyList()
    ...
    private fun initializeComponents() {
        ...
        // Use the repository from CloudCounterApplication which has authManager
        repository = (application as CloudCounterApplication).repository
                ...
                withContext(Dispatchers.IO) {
                    ...
                    if (smoker != null) {
                        ...
                        val gramsForActivity = when (activityType) {
                            com.vibecode.cloudcounter.ActivityType.CONE -> ratios?.coneGrams ?: 0.3
                            com.vibecode.cloudcounter.ActivityType.JOINT -> ratios?.jointGrams ?: 0.5
                            com.vibecode.cloudcounter.ActivityType.BOWL -> ratios?.bowlGrams ?: 0.2
                            else -> 0.3
                        }
                        ...
                        val activity = com.vibecode.cloudcounter.ActivityLog(
                            ...
                            customActivityId = if (activityType == com.vibecode.cloudcounter.ActivityType.CUSTOM) currentActivityId else null,
                            customActivityName = if (activityType == com.vibecode.cloudcounter.ActivityType.CUSTOM) currentActivityName else null,
                        ...
                        if (currentShareCode != null && sessionActiveNow) {
                            ...
                            try {
                                val sessionSyncService = SessionSyncService(this@GiantCounterActivity)
                        ...
                        when (activityType) {
                            com.vibecode.cloudcounter.ActivityType.CONE -> lastConeTimestamp = currentTime
                            com.vibecode.cloudcounter.ActivityType.JOINT -> lastJointTimestamp = currentTime
                            com.vibecode.cloudcounter.ActivityType.BOWL -> lastBowlTimestamp = currentTime
                            else -> {}
                        }
        ...
        lifecycleScope.launch {
            try {
                ...
                val undoneActivity = withContext(Dispatchers.IO) {
                    val dao = com.vibecode.cloudcounter.AppDatabase.getDatabase(this@GiantCounterActivity).activityLogDao()
                ...
                try {
                    ...
                    if (undoneActivity.type == com.vibecode.cloudcounter.ActivityType.CUSTOM && !undoneActivity.customActivityId.isNullOrEmpty()) {
                        goalService.reverseGoalProgressForSelectedActivity(
                            activityType = com.vibecode.cloudcounter.ActivityType.CUSTOM,
        ...
        lifecycleScope.launch {
            try {
                ...
                val allSmokers = withContext(Dispatchers.IO) {
                    val dao = com.vibecode.cloudcounter.AppDatabase.getDatabase(this@GiantCounterActivity).smokerDao()
                ...
                if (allSmokers.isNotEmpty()) {
                    ...
                    val intent = Intent("com.vibecode.cloudcounter.SKIP_SMOKER")
