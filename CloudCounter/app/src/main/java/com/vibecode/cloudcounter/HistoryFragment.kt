...
import com.vibecode.cloudcounter.databinding.FragmentHistoryBinding
...
class HistoryFragment : Fragment(R.layout.fragment_history) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter = HistoryAdapter(
            repo,
            onDeleteLog = { log -> viewModel.deleteActivityWithCloudSync(log) },  // Use comprehensive deletion
