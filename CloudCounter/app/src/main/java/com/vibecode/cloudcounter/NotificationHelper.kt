...
class NotificationHelper(private val context: Context) {
    companion object {
        ...
        const val ACTION_ADD_ENTRY         = "com.vibecode.cloudcounter.ACTION_ADD_ENTRY"
        const val ACTION_REMOVE_LAST_ENTRY = "com.vibecode.cloudcounter.ACTION_REMOVE_LAST_ENTRY"
        const val ACTION_REWIND_SESSION    = "com.vibecode.cloudcounter.ACTION_REWIND_SESSION"
        const val ACTION_ADD_FROM_TURN     = "com.vibecode.cloudcounter.ACTION_ADD_FROM_TURN"
    ...
    fun showActivityNotification(
        ...
        val title = if (justAdded) {
            when (activityType) {
                ...
                ActivityType.CIGARETTE -> "Add a Cigarette"
            ...
            when (activityType) {
                ...
                ActivityType.CIGARETTE       -> "Last Cigarette"
                ActivityType.SESSION_SUMMARY -> "Session Summary"
            }
        }
    ...
    fun showChatMessageNotification(
        ...
        val replyIntent = Intent(context, ChatReplyReceiver::class.java).apply {
            action = "com.vibecode.cloudcounter.REPLY_ACTION"
            putExtra("room_id", roomId)
